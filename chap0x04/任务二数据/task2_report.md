...
```bash
age<20:         9       1.222826%
age between 20 and 30:  600     81.521739%
...
```bash
Goalie: 96 13.061224%
Defender: 236 32.108844%
Midfielder: 268 36.462585%
Forward: 135 18.367347
```
...
- 年龄最大的球员
```bash
The oldest player is Faryd Mondragon, 42
```

- 年龄最小的球员
```bash
The youngest player is Luke Shaw, 18
The youngest player is Fabrice Olinga, 18
```
